        ...
        <div class="section post-section pt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="heading text-center">Blog Yazısı Oluştur</h2>
                        <form action="<?= base_url("kategori/makale_insert"); ?>" id="myForm" method="POST" class="create-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" id="spot" maxlength="200" name="spot" required>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <?php foreach ($yazarlar as $yazar) { ?>
                                    <option value="<?= $yazar->yazar_id ?>"><?= $yazar->isim; ?></option>
                                <?php } ?>
                                </select>
                            </div>
                            ...
                            <br>
                            <button id="submitBtn" type="submit" class="btn btn-primary btn-block" style="display: block; width: 100%;">Blog Yazısını Kaydet</button>
                        </form>
                    </div>
                </div>
            </div>
